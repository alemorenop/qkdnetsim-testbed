 ...
 *
 *   --devData / --myIpData  link to RELAY_ETSI014_ALICE (ETSI014 Alice)
 *   --devKms  / --myIpKms   link to RELAY_KMS_BOB (KMS Bob)
 *
...
main(int argc, char* argv[])
{
    ...
    std::string peerAliceIp = "192.168.121.8"; // RELAY_ETSI014_ALICE
